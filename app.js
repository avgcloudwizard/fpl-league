...
load();
setInterval(()=>{if(!document.hidden&&!$('#profile').open&&!['creator-search','enemy-search','price-search','personal-manager','hindsight-player'].includes(document.activeElement?.id))load(true);},60000);
